...
if (!prefersReduced) {
 ...
 // ========================================
 // 14. ANIMATIONS AU SCROLL (DÉJÀ PRÉSENT)
 // ========================================
 // Scroll animations déjà gérées par reveal + IntersectionObserver

 // ========================================
 // 15. OBSERVER DES MUTATIONS
 // ========================================
  if (MutationObserver in window) {
    const observer = new MutationObserver(() => {
      // Réattacher ripples si DOM change
      attachRipples();
    });
